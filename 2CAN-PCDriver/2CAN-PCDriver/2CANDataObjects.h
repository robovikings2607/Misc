...
{
	unsigned short int arbid_h;
	unsigned short int arbid_l;

#define STo2CAN_CANFrameOption_ExtendedID	(1)
#define STo2CAN_CANFrameOption_Remote		(2)
	unsigned short int len_options;
...
typedef union _STo2CAN_TxCANPacket {
	struct {
		unsigned short int iSig;
		unsigned short int iByteLen;

		unsigned short int iOptions;
		unsigned short int iFrameCnt;
		STo2CAN_CANFrame CANFrames[1];
	};
	struct {
		unsigned short int Words[20];
